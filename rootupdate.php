...
if($_SESSION['username'] != null && $_SESSION['username'] == 'root'){
        ...
        echo "<form name=\"form\" method=\"post\" action=\"rootupdate_finish.php\">";
        echo "帳號：<input type=\"text\" name=\"id\" value=\"$row[1]\" /> <br><br>";
        echo "密碼：<input type=\"password\" name=\"pw\" value=\"\" /> <br><br>";
