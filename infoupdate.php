					...
					<div class="header">    
						...
						<div class="editarea">
							...
							if($_SESSION['username'] != null){
								...
								echo "<form name=\"form\" method=\"post\" action=\"infoupdate_finish.php\">";
								echo "帳號：<input type=\"text\" name=\"id\" value=\"$row[1]\" readonly/>(此項目無法修改) <br><br>";
								echo "電話：<input type=\"text\" name=\"phone\" value=\"$row[3]\" /> <br><br>";
								echo "電子信箱：<input type=\"text\" name=\"mail\" value=\"$row[4]\" /> <br><br>";
								echo "地址：<input type=\"text\" name=\"address\" value=\"$row[5]\" /> <br><br>";
								echo "請輸入密碼：<input type=\"password\" name=\"opw2\" value=\"\" /> <br><br>";
