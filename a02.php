...
if($_SESSION['username'] != null ){
	...
	echo '<div><a href="login_a02.php">登入</a></div>';
...
<div class="container">
  ...
  <div class="editarea">
  	<a href="a02.php"><img src="images/LOGOb.png" width="500" height="500" /></a>
...
if($_SESSION['username'] != null ){
	...
	echo '<div><a href="login_a02.php"><img src="images/loginbtn.png" width="150" height="75" />&nbsp;<a href="register.php"><img src="images/regibtn.png" width="150" height="75" /></a></div>';
